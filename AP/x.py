    ...
    def adicionar_horas(self, horas):
        if horas > 0:
           self.__horas_trabalhadas +=  horas
            ...
            print("Horas deve ser maior qie zero!")  
...
pessoa2 = membroEquipe ("Bernardo", 27, "Designer") 
...
proj1.adicionar_membro(pessoa2)

pessoa1.adicionar_horas(10)
pessoa2.adicionar_horas(8)
